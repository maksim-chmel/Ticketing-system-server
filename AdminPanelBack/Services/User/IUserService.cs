...
{
    Task<PagedResult<UserDto>> GetAllUsers(int page, int pageSize, CancellationToken cancellationToken = default);
    Task<UserDto?> ManageComment(long userId, string comment, CancellationToken cancellationToken = default);
