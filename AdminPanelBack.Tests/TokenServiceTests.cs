...
public class TokenServiceTests
{
    ...
    {
        var result = _service.GenerateToken("test", "test", "Test User", new List<string>());
    ...
    {
        var token1 = _service.GenerateToken("test1", "test1", "User One", new List<string>());
        var token2 = _service.GenerateToken("test2", "test2", "User Two", new List<string>());
    ...
    {
        var result = _service.GenerateToken("test", "test", "Test User", new List<string> { "Admin" });
        result.Should().NotBeNullOrEmpty();
    }
}